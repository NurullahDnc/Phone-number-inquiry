            ...
            <div className="w-[100%] h-full text-center">
                {
                    headerImage.map((item, i) => (
                        <div key={i}>
                            <h1 key={i} className="md:text-3xl text-2xl text-white font-bold mb-1">{item.title} </h1>
                ...
                <form class="max-w-md mx-auto" onSubmit={HandleClick}>
                    ...
                    <div class="relative">
                        ...
                        <input type="tel"
                            ...
                            required />
                        <button type="submit" class="text-white absolute top-[7px] sm:top-2 md:top-2.5 text-[12px] md:text-sm mr-4 md:mr-2 right-0 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Sorgula</button>
                    </div>
                </form>
            </div>
        </div>
