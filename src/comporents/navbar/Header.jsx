                ...
                <div className="md:w-[50%] w-[95%] text-center">
                    ...
                    <form class="max-w-md mx-auto" onSubmit={HandleClick}>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" value={inputData} onChange={(e)=> setInputData(e.target.value)} id="default-search" class="block w-full p-4 ps-10 text-xl text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 font-bold " placeholder="853405429" required />
